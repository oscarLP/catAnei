Public Class Muestra
    ...
    Sub New(ByVal _codigo As String, ByVal _valor_identificado As String, ByVal _nombre As String, ByVal _descripcion As String, _
            ByVal _especie As String, ByVal _anio_cosecha As String, ByVal _fk_codigo_sesion As String, ByVal _fk_codigo_productor As String, ByVal _fk_codigo_proveedor As String)
        codigo = _codigo
