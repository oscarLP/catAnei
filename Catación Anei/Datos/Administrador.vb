...
Public Class Administrador
    ...
    Public Function validad_contraseña(Contrasenia) As Boolean
    ...
    Public Function update_Contraseña(NuevaContraseña) As Boolean
        Dim i As Integer
        Try
            db.Conexion.Open()
    ...
    Public Function select_administrador() As DataTable 'Devuelve el registro del administrador
        Dim Tabla As New DataTable
        Try
