...
Public Class Gestor_Robusta
    Private db As New Conexion_BD
    Private Comando As SqlCommand

    Dim fun As New funcionDeRobusta 'NUEVO

    Public Function Guardar_Robusta(ByVal Robusta As Robusta) As Boolean
        Return fun.Guardar_Robusta(Robusta)
    End Function

    Public Function Atributos_Robusta(ByVal Codigo_Muestra As String) As Robusta
        Return fun.Atributos_Robusta(Codigo_Muestra)
    End Function
    'Public Function Guardar_Robusta(codigo, fk_codigo_muestra) As Boolean
    '    Dim i As Integer
    '    Try
    '        Dim _sql As String = String.Format("INSERT INTO ROBUSTA (codigo, fk_codigo_muestra) VALUES('{0}','{1}')",
